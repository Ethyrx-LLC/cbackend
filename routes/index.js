...
// COMMENT ROUTES
router.post("/listings/:id/comments/create", comments_controller.create_comment_post);
router.get("/listings/:id/comments", comments_controller.list_comments_get);
router.delete("/listings/:id/comments/:id/delete", comments_controller.delete_comment_post);
router.put("/listings/:id/comments/:id/upvote", comments_controller.upvote_comment_post);
router.put("/listings/:id/comments/:id/downvote", comments_controller.downvote_comment_post);
...
router.delete("/categories/:id/delete", categories_controller.category_delete_post);
